    ...
    public function getIndex($orderId)
    {
        ...
        foreach($order->orderLines as $line){
            ...
            if($line->embellishment_option){
                ...
                $line->embellishment_option->order_fabric->fabric->name = $line->embellishment_option->order_fabric->fabric->name;
            ...
            foreach($lineFabrics as $lineFabric){
                ...
                $lineFabric->fabric->name = $lineFabric->fabric->getNameAttribute();
            }
